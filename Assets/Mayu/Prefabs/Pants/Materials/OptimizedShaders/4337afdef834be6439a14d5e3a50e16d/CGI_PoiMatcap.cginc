    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        half2 matcapUV = half2(dot(worldViewRight, poiMesh.normals[(0.75 /*_MatcapNormal*/)]), dot(worldViewUp, poiMesh.normals[(0.75 /*_MatcapNormal*/)])) * (0.4 /*_MatcapBorder*/) + 0.5;
        #if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
        ...
        blendMatcap(finalColor, (0.4 /*_MatcapAdd*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), matcap, matcapMask, matcapEmission, (0.0 /*_MatcapEmissionStrength*/)
        #ifdef POI_LIGHTING
        , (0.5 /*_MatcapLightMask*/)
        #endif
        #ifdef POI_BLACKLIGHT
        , _BlackLightMaskMatcap
        ...
        #ifdef COLOR_GRADING_HDR_3D
            half2 matcapUV2 = half2(dot(worldViewRight, poiMesh.normals[(1.0 /*_Matcap2Normal*/)]), dot(worldViewUp, poiMesh.normals[(1.0 /*_Matcap2Normal*/)])) * (0.5 /*_Matcap2Border*/) + 0.5;
            #if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
            ...
            blendMatcap(finalColor, (1.0 /*_Matcap2Add*/), (1.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), matcap2, matcap2Mask, matcapEmission, (0.0 /*_Matcap2EmissionStrength*/)
            #ifdef POI_LIGHTING
