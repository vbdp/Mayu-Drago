...
float4 frag(v2f i, uint facing: SV_IsFrontFace): COLOR
{
	...
	col.a *= float4(0.05126942,0.05126942,0.05126942,1).a;
	...
	col.rgb *= float4(0.05126942,0.05126942,0.05126942,1).rgb;
	if ((0.0 /*_OutlineMode*/) == 1)
	{
		col.rgb = lerp(col.rgb, mainTexture.rgb, (1.0 /*_OutlineTintMix*/));
	}
	finalColor = col;
