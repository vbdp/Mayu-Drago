...
v2f vert(appdata v)
{
	...
	{
		distanceOffset *= min(distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, localPos).xyz), (1.0 /*_OutlinesMaxDistance*/));
	}
	float3 offset = o.normal * ((0.15 /*_LineWidth*/) * (0.0 /*_commentIfZero_EnableOutlinePass*/) / 100) * outlineMask * distanceOffset;
