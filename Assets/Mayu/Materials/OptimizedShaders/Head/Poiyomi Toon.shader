Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/974cb93762b685145a62ba8e550234f2"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.0.40</color>", Float) = 0
		...
		[sRGBWarning(true)]_DecalTexture ("Decal--{reference_properties:[_DecalTexturePan, _DecalTextureUV, _Decal0MaskChannel, _DecalOverrideAlpha]}", 2D) = "white" { }
		...
		[HideInInspector][ToggleUI]_DecalOverrideAlpha ("Override Alpha--{reference_property:_Decal0OverrideAlphaMode}", Float) = 0
		...
		[ThryWideEnum(Replace, 0, Multiply, 2, Screen, 6, Subtract, 7, Add, 8, Overlay, 9, Mixed, 20)]_DecalBlendType ("Blending", Range(0, 1)) = 0
		...
		[sRGBWarning(true)]_DecalTexture1 ("Decal--{reference_properties:[_DecalTexture1Pan, _DecalTexture1UV, _Decal1MaskChannel, _DecalOverrideAlpha1]}", 2D) = "white" { }
		...
		[HideInInspector][ToggleUI]_DecalOverrideAlpha1 ("Override Alpha--{reference_property:_Decal1OverrideAlphaMode}", Float) = 0
		...
		[ThryWideEnum(Replace, 0, Multiply, 2, Screen, 6, Subtract, 7, Add, 8, Overlay, 9, Mixed, 20)]_DecalBlendType1 ("Blending", Range(0, 1)) = 0
		...
		[sRGBWarning(true)]_DecalTexture2 ("Decal--{reference_properties:[_DecalTexture2Pan, _DecalTexture2UV, _Decal2MaskChannel, _DecalOverrideAlpha2]}", 2D) = "white" { }
		...
		[HideInInspector][ToggleUI]_DecalOverrideAlpha2 ("Override Alpha--{reference_property:_Decal2OverrideAlphaMode}", Float) = 0
		...
		[ThryWideEnum(Replace, 0, Multiply, 2, Screen, 6, Subtract, 7, Add, 8, Overlay, 9, Mixed, 20)]_DecalBlendType2 ("Blending", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void initPoiAudioLink(inout PoiMods poiMods)
			{
				...
				if (LumaIsAvailable())
				{
					...
					poiMods.audioLink[0] = audioLows;
					poiMods.audioLink[1] = audioLows;
					poiMods.audioLink[2] = audioHighs;
					poiMods.audioLink[3] = audioHighs;
			...
			void ApplyGlobalMaskTextures(in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				#endif
				#if defined(PROP_GLOBALMASKTEXTURE2) || !defined(OPTIMIZER_ENABLED)
				float4 gmcol2 = POI2D_SAMPLER_PAN(_GlobalMaskTexture2, _MainTex, poiUV(poiMesh.uv[(2.0 /*_GlobalMaskTexture2UV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				if ((0 /*_GlobalMaskTexture2Split*/))
				{
					poiMods.globalMask[8] = gmcol2.r;
					poiMods.globalMask[9] = POI2D_SAMPLER_PAN(_GlobalMaskTexture2, _MainTex, poiUV(poiMesh.uv[(2.0 /*_GlobalMaskTexture2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)).g;
					poiMods.globalMask[10] = POI2D_SAMPLER_PAN(_GlobalMaskTexture2, _MainTex, poiUV(poiMesh.uv[(2.0 /*_GlobalMaskTexture2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)).b;
					poiMods.globalMask[11] = POI2D_SAMPLER_PAN(_GlobalMaskTexture2, _MainTex, poiUV(poiMesh.uv[(2.0 /*_GlobalMaskTexture2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)).a;
				} else {
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				else if ((1.0 /*_LightingAdditiveType*/) == 1) // Toon
				{
					...
					float passthrough = 0;
					#else
					float passthrough = (0.005 /*_LightingAdditivePassthrough*/);
					#endif
					if ((0.5 /*_LightingAdditiveGradientEnd*/) == (0.3 /*_LightingAdditiveGradientStart*/)) (0.5 /*_LightingAdditiveGradientEnd*/) += 0.001;
					poiLight.rampedLightMap = smoothstep((0.5 /*_LightingAdditiveGradientEnd*/), (0.3 /*_LightingAdditiveGradientStart*/), 1 - (.5 * poiLight.nDotL + .5));
					#if defined(POINT) || defined(SPOT)
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.additiveShadow, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.3 /*_LightingAdditiveGradientStart*/), (0.5 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5))) * poiLight.attenuation;
					#else
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.attenuation, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.3 /*_LightingAdditiveGradientStart*/), (0.5 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5)));
					#endif
					return;
				}
				#endif
				float shadowStrength = (0.75 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				...
				lightMap.y *= lerp(1.0, shadowAttenuationNoStrength, (1.0 /*_Shadow2ndReceive*/));
				lightMap.z *= lerp(1.0, shadowAttenuationNoStrength, (1.0 /*_Shadow3rdReceive*/));
				...
				{
					lns.x = poiEdgeNonLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.2 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeNonLinearNoSaturate(lightMap.y, (0.3 /*_Shadow2ndBorder*/), (0.4 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeNonLinearNoSaturate(lightMap.z, (0.1 /*_Shadow3rdBorder*/), (0.2 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeNonLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.2 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				else
				{
					lns.x = poiEdgeLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.2 /*_ShadowBlur*/) * blurMap.r);
					lns.y = poiEdgeLinearNoSaturate(lightMap.y, (0.3 /*_Shadow2ndBorder*/), (0.4 /*_Shadow2ndBlur*/) * blurMap.g);
					lns.z = poiEdgeLinearNoSaturate(lightMap.z, (0.1 /*_Shadow3rdBorder*/), (0.2 /*_Shadow3rdBlur*/) * blurMap.b);
					lns.w = poiEdgeLinearNoSaturate(lightMap.x, (0.6 /*_ShadowBorder*/), (0.2 /*_ShadowBlur*/) * blurMap.r, (0.0 /*_ShadowBorderRange*/));
				}
				#if defined(PROP_SHADOWBORDERMASK) || !defined(OPTIMIZER_ENABLED)
				...
				if (float4(0.301212,0.301212,0.301212,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.301212,0.301212,0.301212,1).rgb;
				}
				if (float4(0.0651107,0.0651107,0.0651107,1).a > 0)
				{
					#if defined(PROP_SHADOW2NDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow2ndColorTex.rgb = lerp(float3(1, 1, 1), shadow2ndColorTex.rgb, shadow2ndColorTex.a) * float4(0.0651107,0.0651107,0.0651107,1).rgb;
					lns.y = float4(0.0651107,0.0651107,0.0651107,1).a - lns.y * float4(0.0651107,0.0651107,0.0651107,1).a;
					indirectColor = lerp(indirectColor, shadow2ndColorTex.rgb, lns.y);
				}
				if (float4(0.01370207,0.01370207,0.01370207,1).a > 0)
				{
					#if defined(PROP_SHADOW3RDCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					shadow3rdColorTex.rgb = lerp(float3(1, 1, 1), shadow3rdColorTex.rgb, shadow3rdColorTex.a) * float4(0.01370207,0.01370207,0.01370207,1).rgb;
					lns.z = float4(0.01370207,0.01370207,0.01370207,1).a - lns.z * float4(0.01370207,0.01370207,0.01370207,1).a;
					indirectColor = lerp(indirectColor, shadow3rdColorTex.rgb, lns.z);
				}
				indirectColor = lerp(indirectColor, indirectColor * poiFragData.baseColor, (1.0 /*_ShadowMainStrength*/));
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if (lightingMode == 0)
						{
							vertexLighting = max(vertexLighting, poiLight.vColor[index] * poiLight.vAttenuationDotNL[index] * poiLight.detailShadow); // Realistic
						}
						if (lightingMode == 1) // Toon
						{
							vertexLighting = max(vertexLighting,lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.005 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.3 /*_LightingAdditiveGradientStart*/), (0.5 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.detailShadow);
						}
					}
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalGlobalMask = (5.0 /*_Decal0GlobalMask*/);
				...
				Decal0.m_DecalTexture_ST = float4(5,5,0,0);
				...
				Decal1.m_DecalGlobalMask = (5.0 /*_Decal1GlobalMask*/);
				Decal1.m_DecalGlobalMaskBlendType = (0.0 /*_Decal1GlobalMaskBlendType*/);
				...
				Decal1.m_DecalTexture_ST = float4(10,10,0,0);
				...
				Decal1.m_DecalBlendType = (6.0 /*_DecalBlendType1*/);
				...
				Decal1.m_DecalRotationSpeed = (0.1 /*_DecalRotationSpeed1*/);
				...
				Decal2.m_DecalTextureUV = (1.0 /*_DecalTexture2UV*/);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float3 normal0 = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.75 /*_MatcapNormal*/));
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (2.0 /*_MatcapUVMode*/), (1.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_MatcapRotation*/), (0.4 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (0.75 /*_MatcapNormal*/), matcapALD);
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.4 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.4 /*_MatcapMixed*/), (0.2 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.5 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (1.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (0.0 /*_Matcap2UVMode*/), (1.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap2Rotation*/), (0.4 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (1.0 /*_Matcap2Normal*/), matcapALD);
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				matcapIntensity = (0.75 /*_Matcap2Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				matcap2.rgb = lerp(matcap2.rgb, matcap2.rgb * poiFragData.baseColor.rgb, (0.75 /*_Matcap2BaseColorMix*/));
				#if defined(PROP_MATCAP2MASK) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.4 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.4 /*_Matcap2Mixed*/), (0.2 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (1.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (0.25 /*_EmissionStrength*/);
				...
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (0.1 /*_GITDEMinEmissionMultiplier*/), (1.0 /*_GITDEMaxEmissionMultiplier*/), (1.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_EmissionMask1GlobalMask*/) > 0)
				{
					emissionMask1 = maskBlend(emissionMask1, poiMods.globalMask[(1.0 /*_EmissionMask1GlobalMask*/) - 1], (2.0 /*_EmissionMask1GlobalMaskBlendType*/));
				}
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0.3364187,0.4718656,0.5283019,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0.3364187,0.4718656,0.5283019,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0.3364187,0.4718656,0.5283019,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
				...
				if ((2.0 /*_EmissionMask2GlobalMask*/) > 0)
				{
					emissionMask2 = maskBlend(emissionMask2, poiMods.globalMask[(2.0 /*_EmissionMask2GlobalMask*/) - 1], (2.0 /*_EmissionMask2GlobalMaskBlendType*/));
				}
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier3 = calculateGlowInTheDark((0.0 /*_GITDEMinLight3*/), (1.0 /*_GITDEMaxLight3*/), (0.0 /*_GITDEMinEmissionMultiplier3*/), (1.0 /*_GITDEMaxEmissionMultiplier3*/), (0.0 /*_EnableGITDEmission3*/), (0.0 /*_GITDEWorldOrMesh3*/), poiLight);
				#if defined(PROP_EMISSIONMAP3) || !defined(OPTIMIZER_ENABLED)
				...
				emissionColor3 = hueShift(emissionColor3, frac((0.0 /*_EmissionHueShift3*/) + (0.0 /*_EmissionHueShiftSpeed3*/) * _Time.x) * (0.0 /*_EmissionHueShiftEnabled3*/));
				#if defined(PROP_EMISSIONMASK3) || !defined(OPTIMIZER_ENABLED)
				...
				if ((3.0 /*_EmissionMask3GlobalMask*/) > 0)
				{
					emissionMask3 = maskBlend(emissionMask3, poiMods.globalMask[(3.0 /*_EmissionMask3GlobalMask*/) - 1], (2.0 /*_EmissionMask3GlobalMaskBlendType*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(unity_LightColor[index].rgb, (3.0 /*_LightingAdditiveLimit*/)) : unity_LightColor[index].rgb;
				...
				{
					poiLight.directColor = max(poiLight.directColor, (0.005 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor = max(poiLight.directColor, poiLight.directColor * min(10000, ((0.005 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.directColor)))));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor * min(10000, ((0.005 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.indirectColor)))));
				}
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(_LightColor0.rgb, (3.0 /*_LightingAdditiveLimit*/)) : _LightColor0.rgb;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				poiLight.indirectColor = 0;
				#else
				poiLight.indirectColor = lerp(0, poiLight.directColor, (0.005 /*_LightingAdditivePassthrough*/));
				...
				if ((1.0 /*_FXProximityColor*/))
				{
					...
					poiFragData.finalColor *= lerp(poiThemeColor(poiMods, float4(0.2140411,0.2140411,0.2140411,1).rgb, (0.0 /*_FXProximityColorMinColorThemeIndex*/)), poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_FXProximityColorMaxColorThemeIndex*/)), smoothstep((0.0 /*_FXProximityColorMinDistance*/), (0.1 /*_FXProximityColorMaxDistance*/), distance(position, poiCam.worldPos)));
					if ((0.0 /*_FXProximityColorBackFace*/))
					{
						poiFragData.finalColor = lerp(poiFragData.finalColor * float4(0.2140411,0.2140411,0.2140411,1).rgb, poiFragData.finalColor, saturate(poiMesh.isFrontFace));
					}
				}
